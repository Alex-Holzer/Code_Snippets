...
def analyze_dual_dimension_performance(
    df: DataFrame,
    case_key_col: str = "_CASE_KEY",
    dimension1_col: str = "DIMENSION 1",
    dimension2_col: str = "DIMENSION 2",
    ...
    """
    Analyze performance metrics for each combination of two dimensions in the process data.

    This function calculates various performance indicators for each unique combination
    of two dimensions, helping to identify low-performing areas across all cases.

    Args:
        df (DataFrame): Input DataFrame containing process data.
        case_key_col (str): Column name for the case key. Default is "_CASE_KEY".
        dimension1_col (str): Column name for the first dimension to analyze. Default is "DIMENSION 1".
        dimension2_col (str): Column name for the second dimension to analyze. Default is "DIMENSION 2".
    ...
    Returns:
        DataFrame: A DataFrame containing the performance analysis results with columns:
            - dimension1: The unique value from the first dimension column
            - dimension2: The unique value from the second dimension column
            - avg_duration: The average duration for completed cases in this dimension combination
            - median_duration: The median duration for completed cases in this dimension combination
            - min_duration: The minimum duration for completed cases in this dimension combination
            - max_duration: The maximum duration for completed cases in this dimension combination
            - std_dev_duration: The standard deviation of durations for completed cases in this dimension combination
            - total_cases: The total number of cases for this dimension combination
            - completed_cases: The number of completed cases for this dimension combination
    ...
    Example:
        ...
        >>> dimension_performance = analyze_dual_dimension_performance(
        ...     df, 
        ...     dimension1_col="DIMENSION 1",
        ...     dimension2_col="DIMENSION 2",
    ...
    Note:
        ...
        - Low-performing dimension combinations can be identified by comparing metrics such as
          avg_duration, median_duration, completion_rate, etc., across different combinations.
        - A high std_dev_duration might indicate inconsistent performance within a dimension combination.
        - Low completion_rate might suggest process bottlenecks or issues in specific dimension combinations.
    ...
    required_columns = [case_key_col, dimension1_col, dimension2_col, activity_col, timestamp_col]
    ...
    # Calculate performance metrics for each dimension combination
    dimension_performance = df_with_completion.groupBy(dimension1_col, dimension2_col).agg(
    ...
    final_columns = [dimension1_col, dimension2_col, "avg_duration", "median_duration", "min_duration", "max_duration", 
