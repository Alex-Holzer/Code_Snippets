...
def analyze_dimension_ceteris_paribus(
    df: DataFrame,
    ...
    """
    Analyze performance metrics for a target dimension while keeping other dimensions constant.

    This function calculates various performance indicators for each unique value of the target dimension,
    ...
    Returns:
        DataFrame: A DataFrame containing the ceteris paribus performance analysis results with columns:
            ...
            - avg_duration: The average duration for completed cases
            - median_duration: The median duration for completed cases
            - min_duration: The minimum duration for completed cases
            - max_duration: The maximum duration for completed cases
            - std_dev_duration: The standard deviation of durations for completed cases
    ...
    Example:
        ...
        >>> ceteris_paribus_results = analyze_dimension_ceteris_paribus(
        ...     df, 
    ...
    Note:
        ...
        - This approach helps isolate the effect of the target dimension on performance metrics.
    ...
    dimension_performance = df_with_completion.groupBy(*all_dimensions).agg(
    ...
    final_columns = ceteris_paribus_cols + [target_dimension_col, "avg_duration", "median_duration", 
                                            "min_duration", "max_duration", "std_dev_duration", 
                                            "total_cases", "completed_cases", "completion_rate"]
